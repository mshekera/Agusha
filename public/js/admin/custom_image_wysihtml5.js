	...
	initInsertImage: function(toolbar) {
		...
		var insertImage = function(imageData) {
			if(imageData.url) {
				...
				var tmpl = helpers.getImageTemplate(imageData.url);
		...
		// toolbar.find('a[data-wysihtml5-command=wysiwyg-text-align-left]').click(function() {
		// 	// self.editor.composer.commands.exec("justifyCenter");
		// 	self.editor.composer.commands.exec("formatBlock",null,"alignBlock")
		// });
...
$(function() {
	...
	var wysiwygOptions = {
		...
		customStyles: {
			...
			'chat': null,
			'caption': null,
			// "wysiwyg-text-align-center": "align-left"
		},
		classes: {
			"wysiwyg-text-align-center": "alignLeft"
		},
		customTemplates: {
			...
			image: function(params) {
				...
				return "<li>" +
					...
					"<li>"+
						"<div class=\"btn-group\">"+
							"<a class=\"btn btn-default\" tabindex='1' unselectable='on' data-wysihtml5-command='justyfyLeft' title=\"Text align left\">"+
